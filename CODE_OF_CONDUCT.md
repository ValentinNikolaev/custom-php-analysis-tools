...
project maintainer using a private contact method linked from the
[@ValentinNikolaev GitHub profile](https://github.com/ValentinNikolaev). Do not
include sensitive details in a public issue. If no private method is available,
open an issue that asks the maintainer to contact you without describing the
incident publicly.
